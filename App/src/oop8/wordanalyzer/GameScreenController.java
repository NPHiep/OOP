...
import oop8.utils.ScoreDialogController;
...
public class GameScreenController extends Controller {
    ...
    public void initGame(Stage stage) {
        if (unusedList.contains("a")) System.out.println("CNGT");
        this.stage = stage;
...
//            @Override
//            public void run() {
//                ScaleTransition scaleTransition = ScaleTransitionBuilder.create().node(imgTrue)
//                        .duration(Duration.seconds(4)).toX(3).toY(3).cycleCount(Timeline.INDEFINITE).autoReverse(true).build();
