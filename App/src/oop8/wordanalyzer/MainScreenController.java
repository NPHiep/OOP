...
import oop8.utils.Controller;
import oop8.utils.HighScoreItem;
import oop8.utils.WordItem;
import oop8.utils.parsers.CHMParser;
...
public class MainScreenController extends Controller {
    ...
    @FXML private AnchorPane frontLayer;
    ...
    public void tutorialButtonAction() {
        frontLayer.setMouseTransparent(false);
        frontLayer.setOpacity(.5);
        tutorialView.setImage(new Image(getClass().getResourceAsStream("../imgs/cover.png")));
        tutorialView.setOpacity(.9);
        toolbarPane.setDisable(true);
    }

    public void quitTutorial(){
        frontLayer.setMouseTransparent(true);
        frontLayer.setOpacity(0);
        tutorialView.setOpacity(0);
        tutorialView.setImage(null);
        toolbarPane.setDisable(false);
    }
}
