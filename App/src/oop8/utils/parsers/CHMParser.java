...
/**
 * CHMParser - parser a chm file to get plain text extends from AbstractParser class in tika libarary
 */
public class CHMParser extends AbstractParser{
    ...
    public void parse(InputStream inputStream, ContentHandler contentHandler, Metadata metadata, ParseContext parseContext) throws IOException, SAXException, TikaException {
        Extractor extractor = new Extractor(file, outputDirectory, filter);
        try {
            extractor.extract();
    ...
    /**
     * parser html element after extract chm file
     * @param file
     * @return html file's content
